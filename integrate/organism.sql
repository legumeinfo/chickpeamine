...
UPDATE organism SET
genus='Arietium', species='cicer',
shortname='A. cicer (kabuli)', name='Arietinum cicer (desi)', commonname='chickpea (desi)', 
...
UPDATE organism SET 
genus='Arietium', species='cicer',
shortname='A. cicer (kabuli)', name='Arietinum cicer (kabuli)', commonname='chickpea (kabuli)', 
